...
const TOKENS: { name: string; value: string; use: string }[] = [
  { name: "--ink", value: "#0F1B33", use: "primary text, headers" },
  { name: "--slate", value: "#525C73", use: "secondary text, labels, captions" },
  { name: "--mute", value: "#8A92A6", use: "placeholder and disabled text only" },
  { name: "--line", value: "#DCE1EB", use: "borders, dividers, table rules" },
  { name: "--surface", value: "#FFFFFF", use: "cards, tables, panels" },
  { name: "--canvas", value: "#F6F8FC", use: "page background" },
  { name: "--accent", value: "#1B3A6B", use: "links, primary buttons, focus" },
  { name: "--accent-sub", value: "#E6ECF6", use: "accent wash, selected rows" },
  { name: "--clear", value: "#1A6A4A", use: "on track, approved, confirmed" },
  { name: "--clear-bg", value: "#E8F1EC", use: "clear background" },
  { name: "--watch", value: "#8A5A12", use: "at risk, due soon, awaiting" },
  { name: "--watch-bg", value: "#F5EEE1", use: "watch background" },
  { name: "--critical", value: "#A32E28", use: "blocking, overdue, failed" },
  { name: "--critical-bg", value: "#F7E9E8", use: "critical background" },
  { name: "--idle", value: "#525C73", use: "not started, N/A, complete" },
  { name: "--idle-bg", value: "#EDEFF5", use: "idle background" },
];
...
const CONTRAST_PAIRS: {
  ...
  { fg: "ink", fgHex: "#0F1B33", bg: "surface", bgHex: "#FFFFFF" },
  { fg: "slate", fgHex: "#525C73", bg: "surface", bgHex: "#FFFFFF" },
  {
    fg: "mute",
    fgHex: "#8A92A6",
    bg: "surface",
  ...
  { fg: "accent", fgHex: "#1B3A6B", bg: "surface", bgHex: "#FFFFFF" },
  { fg: "accent", fgHex: "#1B3A6B", bg: "accent-sub", bgHex: "#E6ECF6" },
  { fg: "clear", fgHex: "#1A6A4A", bg: "canvas", bgHex: "#F6F8FC" },
  { fg: "clear", fgHex: "#1A6A4A", bg: "clear-bg", bgHex: "#E8F1EC" },
  { fg: "watch", fgHex: "#8A5A12", bg: "surface", bgHex: "#FFFFFF" },
  { fg: "watch", fgHex: "#8A5A12", bg: "canvas", bgHex: "#F6F8FC" },
  { fg: "watch", fgHex: "#8A5A12", bg: "watch-bg", bgHex: "#F5EEE1" },
  { fg: "critical", fgHex: "#A32E28", bg: "canvas", bgHex: "#F6F8FC" },
  { fg: "critical", fgHex: "#A32E28", bg: "critical-bg", bgHex: "#F7E9E8" },
  { fg: "surface", fgHex: "#FFFFFF", bg: "accent", bgHex: "#1B3A6B" },
  { fg: "surface", fgHex: "#FFFFFF", bg: "critical", bgHex: "#A32E28" },
  { fg: "idle", fgHex: "#525C73", bg: "idle-bg", bgHex: "#EDEFF5" },
  { fg: "slate", fgHex: "#525C73", bg: "canvas", bgHex: "#F6F8FC" },
];
...
const TYPE_ROLES: { role: string; className: string; sample: string }[] = [
  ...
  { role: "Body and table cell · 12px / 400, −0.01em in table cells", className: "text-body", sample: "Attendee list confirmed with the client's events team." },
  { role: "Table header · 11px / 500 slate uppercase 0.04em", className: "text-table-header font-medium uppercase tracking-[0.04em] text-slate", sample: "Countdown" },
  ...
  { role: "Time and count · 13px / 400 mono tabular", className: "text-time font-time", sample: "T-24d" },
