 ...
 * Environment check.
 *
 * Confirms the app runs and the environment variables are wired up. Moved off
 * `/` once there was a real landing screen; it is a diagnostic, not a product
 * screen, so it is deliberately outside the app shell and undesigned.
 */
export default function HealthPage() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      <h1 className="text-page-title font-semibold">Environment check</h1>
      <p className="mt-2 text-body text-slate">
        Confirms the app is running and the environment variables are set. The
        product starts at <Link className="text-accent underline underline-offset-2" href="/programs">/programs</Link>.
      </p>
